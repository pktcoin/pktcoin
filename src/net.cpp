...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Pktcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pktcointools.com", "172.104.186.150"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pktcointools.com", "testnet-seed.pktcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Pktcoin is probably already running."), addrBind.ToString().c_str());
        else
